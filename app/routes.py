...
from .models import Product, Cart, Order,Customer,Content
from .forms import ShopItemsForm,OrderForm,ContentForm
...
"""
"""@main.route('/shop-items', methods=['GET', 'POST'])
@login_required
def shop_items():
    if current_user.id == 1:
...
CATEGORIES = {
    "kitchen_accessories": [
        ...
        "Kitchen Accessories", "LIGHTS", "Wardrobe Accessories", "Spice Racks", "Drawer Organizers", "bed", 
    ...
    "boards_materials": [
        "BLOCK BOARDS", "BOARDS", "EDGE BANDING", "MDF HIGH GLOSS BOARDS", "Particle Boards", "bed", 
    ...
    "kitchen_furniture": [
        "Furniture", "Barn Chairs", "Beds", "Dining Chairs", "Stools", "Tables", "Bar Stools", "Dining Tables", "bed", 
        "Cabinets", "Buffets", "Sideboards", "Sofa Sets", "Coffee Tables", "Console Tables", "Cabinet Stands", 
    ...
    "flooring": [
        "Floors", "Hardwood Flooring", "Laminate Flooring", "Vinyl Flooring", "Carpet Tiles", "Rugs", "bed", 
        "Area Rugs", "Wooden Planks", "Ceramic Tiles", "Porcelain Tiles", "Mosaic Tiles", "Bamboo Flooring", 
        "Cork Flooring", "Engineered Wood Flooring", "Stone Flooring", "Marble Flooring", "Granite Flooring", 
        "Concrete Flooring", "Epoxy Flooring", "Rubber Flooring", "Sisal Rugs", "Wool Carpets", "Synthetic Rugs", 
