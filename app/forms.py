...
class ContentForm(FlaskForm):
        ...
        display = StringField("Display Text")
...
# Removed duplicate CheckoutForm class definition
...
class CheckoutForm(FlaskForm):
    # Adding all necessary fields for billing details and the form submission
